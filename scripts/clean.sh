...
sudo dd if=/dev/zero of=/opt/EMPTY bs=1M
sudo rm -f /opt/EMPTY
...
sudo dd if=/dev/zero of=/var/log/EMPTY bs=1M
sudo rm -f /var/log/EMPTY

sudo dd if=/dev/zero of=/boot/efi/EMPTY bs=1M
sudo rm -f /boot/efi/EMPTY
